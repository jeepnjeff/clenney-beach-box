        ...
        <div class="modal-content modal-form">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal col-sm-12 ajax" autocomplete="off" method="post" action="email.php" id="contact-form">
                    ...
                    <div class="form-group"><label id="names">Names</label><input class="form-control" placeholder="Your name"
                            data-placement="top" data-trigger="manual" data-content="Must be at least 3 characters long, and must only contain letters."
                            type="text" name="names" id="names"></div>

                    <div class="form-group"><label>Name</label><input class="form-control required" placeholder="Your name"
                            data-placement="top" data-trigger="manual" data-content="Must be at least 3 characters long, and must only contain letters."
                            type="text" name="name" id='name'></div>

                    <div class="form-group"><label>Message</label><textarea class="form-control message required"
                            placeholder="Your message here.." data-content="Please leave a message." data-placement="top"
                            type="text" data-trigger="manual" name="message" id="message"></textarea></div>

                    <div class="form-group"><label>E-Mail</label><input class="form-control email required" placeholder="email@you.com (so that we can contact you)"
                    ...
                    <div class="form-group"><label>Phone</label><input class="form-control phone required" placeholder="999-999-9999"
                            data-placement="top" data-trigger="manual" data-content="Must be a valid phone number (999-999-9999)"
                    ...
                    <div class="form-group"><button name="submit" type="submit" id="submit" value="Send" class="btn btn-success pull-right">Send
                            It!</button>
